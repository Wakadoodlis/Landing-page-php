...
?>
    ...
    <!-- Main container -->
    <div class="container shadow-sm p-1 mb-1 bg-secondary rounded">


        <!-- JUMBATRONAS -->
        <div class="jumbotron rotateK-5 border ml-5">
            <h1 class="display-4 galer_title">Your Gallery!</h1>
            <p class="lead">Welcome! Here You will find photo gallery of our work, that we have done in Lithuania and abroad! If You like
                what You see - Click that little button at the end of the gallery ;) </p>
            <hr class="my-3 style-eight">
            <p>Galerija nuo 2017 - 2018 m.</p>
